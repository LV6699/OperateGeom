                                              ...
                                              double& dis)
{
    ...
    gocal.AngleIsBetweenAngles(startAgl_,endAgl_,arc._isCW,
                                              ...
                                              double& dis)
{
    if(ele._type == LINETYPE){
        if(isCloseSp){
            dis = P.Distance2D(ele._segment._segSp);
        }else{
            dis = P.Distance2D(ele._segment._segEp);
        }
...
void GeomDistance::PointToArcDistance(const Point &P,
                                      const DefArc &arc,
                                      double &distance)
{
    GeomCalculate gocal;
                                      ...
                                      double &distance)
{
    ...
    if(isOnSeg){
        ...
        if(isExiInt){
            double dis;
            gocal.PointToLineDistance(lSp,lEp,arcCp,dis);
                                          ...
                                          double &distance)
{
    if(ele._type == LINETYPE)
        ...
        distance = PointToArcMaxDistance(P,ele.GetArc());
    else if(ele._type == CIRCLETYPE)
        distance = PointToCircleMaxDistance(P,ele.GetCircle());
    else
        distance = 0;
}
