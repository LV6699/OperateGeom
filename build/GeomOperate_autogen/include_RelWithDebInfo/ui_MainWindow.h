...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        if (QIcon::hasThemeIcon(iconThemeName)) {
            ...
            icon1.addFile(QString::fromUtf8(":/new/img/Resources/FitAll.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
        ...
        if (QIcon::hasThemeIcon(iconThemeName)) {
            ...
            icon2.addFile(QString::fromUtf8(":/new/img/Resources/Rotate.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
        ...
        if (QIcon::hasThemeIcon(iconThemeName)) {
            ...
            icon3.addFile(QString::fromUtf8(":/new/img/Resources/reset.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
        ...
        if (QIcon::hasThemeIcon(iconThemeName)) {
            ...
            icon4.addFile(QString::fromUtf8(":/new/img/Resources/FitAll.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
        ...
        if (QIcon::hasThemeIcon(iconThemeName)) {
            ...
            icon5.addFile(QString::fromUtf8(":/new/img/Resources/import.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
