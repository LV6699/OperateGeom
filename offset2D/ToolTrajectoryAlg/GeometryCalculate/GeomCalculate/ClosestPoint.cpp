                                          ...
                                          Point& cloPt)
{
    ...
    if(isIn){
        GeomIntRes intRes;
        GeomIntersect().CalculateLineCircleInt(P,arc.GetCp(),
                                               arc.GetCp(),
                                               arc.R(),
                                               PreErr5_10,
                                               PreErr5_10,intRes);
        ...
        cloPt = dis1 <= dis2 ? arc.GetSp() : arc.GetEp();
    }
    cloPt.SetZ(arc.GetCp().Z());
}
                                              ...
                                              Point& cloPt)
{
    ...
    case LINETYPE:
        PointToSegmentClosestPoint(P,element._segment.GetSp(),
                                   element._segment.GetEp(),cloPt);
        break;
    case ARCTYPE:
                                            ...
                                            Point &cloPt2)
{
    ...
    Point proPt;
    Point arcSp = arc.GetSp(),arcEp = arc.GetEp(),
            arcCp = arc.GetCp();
    GeomCalculate gocal;
    PointOnElement onele;
                                        ...
                                        Point &cloPt2)
{
    ...
    GeomCalculate gocal;
    Point arcSp1 = arc1.GetSp(),arcEp1 = arc1.GetEp(),
            arcCp1 = arc1.GetCp(),arcSp2 = arc2.GetSp(),
            arcEp2 = arc2.GetEp(),arcCp2 = arc2.GetCp();
    double ssDis,seDis,esDis,eeDis;
