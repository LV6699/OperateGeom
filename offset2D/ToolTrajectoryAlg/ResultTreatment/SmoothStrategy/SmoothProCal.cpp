                                                 ...
                                                 DefArc& arcData)
{
    ...
    smoCal_go->TriangleRotDirection(l1Sp,l1Ep,l2Ep,arcData._isCW);
    bool iscw = !arcData._isCW;
    double aglAbsVal;
    smoCal_go-> TwoAngleIncludedAngle(sTheta,aveAgl,iscw,aglAbsVal);
                                                ...
                                                Point &centerPnt)
{
    ...
    smoCal_equ->EquidistantArc(arcData1,radius,false,
                               false,isExiEquiArc,
                               arcData1_out);
    smoCal_equ->EquidistantArc(arcData2,radius,false,
                               false,isExiEquiArc,
                               arcData2_out);
    smoCal_equ->EquidistantArc(arcData1,radius,true,
                               false,isExiEquiArc,
                               arcData1_wit);
    smoCal_equ->EquidistantArc(arcData2,radius,true,
                               false,isExiEquiArc,
                               arcData2_wit);
    GeomIntersect goInt;
    GeomIntRes intRes;
    ...
    if(intRes._isExistInt){
        ...
        if(intRes._isExistInt){
            if(intRes._intNum == 1){
                ...
                smoCal_intPnt->GetCloseArcExtremePnt(arcData1_wit,intRes._intPnt1,
                                                     intRes._intPnt2,false,
                                                     centerPnt);
            }
        }
