...
public:
    //! Constructor
    OcctWindow(QWidget *theWidget, const Quantity_NameOfColor theBackColor =
    ...
    virtual void Size(Standard_Integer &theWidth, Standard_Integer &theHeight)
    const;
    virtual Aspect_FBConfig NativeFBConfig() const Standard_OVERRIDE { return
                NULL; }
